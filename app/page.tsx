    ...
    <div className="min-h-screen">
      <div className="mx-auto max-w-6xl px-4 py-8 sm:py-10">
        ...
        <div className="mt-6 sm:mt-8 grid gap-4">
          <div className="rounded-3xl border border-white/10 bg-white/60 p-4 sm:p-5">
            <div className="flex flex-col sm:flex-row gap-4 sm:items-center sm:justify-between">
                      ...
                      <button
                        ...
                        className={[
                          ...
                          active
                            ...
                            : "bg-white/30 text-black/70 hover:bg-white/70 border-white/20",
                        ].join(" ")}
                      >
                        {label}
                      </button>
              ...
              <input
                ...
                className="w-full sm:w-[360px] rounded-2xl text-black/70 bg-black/0 border border-black/50 px-4 py-3 outline-none focus:ring-2 focus:ring-white placeholder-black/70"
              />
            </div>
          </div>
